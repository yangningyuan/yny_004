<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LuckJDList.aspx.cs" Inherits="yny_004.Web.mobile.html.LuckJDList" %>
    ...
    $('.i_signIn_btnqhb').on('click', function () {
        ...
        $.ajax({
            ...
            success: function (info) {
                ...
                setTimeout(function () {
                    pcallhtml('/mobile/html/LuckJDList.aspx', '见点记录');
                }, 1000);
            }
        });
    })
...
<script type="text/javascript">
    setTimeout(function () {
        $('#page_container').Paging({
            ...
            DataUrl: '/mobile/html/LuckJDList.aspx?Action=Other',
